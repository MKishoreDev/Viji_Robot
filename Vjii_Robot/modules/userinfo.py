...
from Vjii_Robot.__main__ import STATS, TOKEN, USER_INFO
import Vjii_Robot.modules.sql.userinfo_sql as sql
from Vjii_Robot.modules.disable import DisableAbleCommandHandler
from Vjii_Robot.modules.sql.global_bans_sql import is_user_gbanned
from Vjii_Robot.modules.sql.afk_redis import is_user_afk, afk_reason
from Vjii_Robot.modules.sql.users_sql import get_user_num_chats
from Vjii_Robot.modules.helper_funcs.chat_status import sudo_plus
from Vjii_Robot.modules.helper_funcs.extraction import extract_user
from Vjii_Robot import telethn as SaitamaTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/ClubHousexd/556939">?</a>]'.format(bot.username)
