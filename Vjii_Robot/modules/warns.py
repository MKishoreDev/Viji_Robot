...
import telegram
from Vjii_Robot import TIGERS, WOLVES, dispatcher
from Vjii_Robot.modules.disable import DisableAbleCommandHandler
from Vjii_Robot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from Vjii_Robot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from Vjii_Robot.modules.helper_funcs.string_handling import split_quotes
from Vjii_Robot.modules.log_channel import loggable
from Vjii_Robot.modules.sql import warns_sql as sql
