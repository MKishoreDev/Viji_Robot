...
import Vjii_Robot.modules.sql.notes_sql as sql
from Vjii_Robot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from Vjii_Robot.__main__ import DATA_IMPORT
from Vjii_Robot.modules.helper_funcs.chat_status import user_admin
from Vjii_Robot.modules.helper_funcs.alternate import typing_action

# from Vjii_Robot.modules.rules import get_rules
import Vjii_Robot.modules.sql.rules_sql as rulessql

# from Vjii_Robot.modules.sql import warns_sql as warnssql
import Vjii_Robot.modules.sql.blacklist_sql as blacklistsql
from Vjii_Robot.modules.sql import disable_sql as disabledsql

# from Vjii_Robot.modules.sql import cust_filters_sql as filtersql
# import Vjii_Robot.modules.sql.welcome_sql as welcsql
import Vjii_Robot.modules.sql.locks_sql as locksql
from Vjii_Robot.modules.connection import connected
...
def export_data(update, context):
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Vjii_Robot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Vjii_Robot-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("Vjii_Robot{}.backup".format(chat_id))  # Cleaning file
