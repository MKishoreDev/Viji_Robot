...
from Vjii_Robot import OWNER_ID, SUPPORT_CHAT
from Vjii_Robot.events import register
from Vjii_Robot import telethn
...
async def lego(event):
    ...
    try:
        ...
        fillcolor = "black"
        shadowcolor = "blue"
        fnt = glob.glob("./Vjii_Robot/utils/Logo/*")
        ...
        await telethn.send_file(
            event.chat_id, file=fname, caption=f"Made by @Vjii_Robot"
        )
        await pesan.delete()
