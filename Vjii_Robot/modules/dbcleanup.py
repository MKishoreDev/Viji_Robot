...
import Vjii_Robot.modules.sql.global_bans_sql as gban_sql
import Vjii_Robot.modules.sql.users_sql as user_sql
from Vjii_Robot import DEV_USERS, OWNER_ID, dispatcher
