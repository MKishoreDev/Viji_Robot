...
from Vjii_Robot import BOT_USERNAME, dp
from Vjii_Robot.config import get_bool_key
from Vjii_Robot.modules.error import parse_update
from Vjii_Robot.utils.filters import ALL_FILTERS
from Vjii_Robot.utils.logger import log
...
for module_name in ALL_FILTERS:
    ...
    imported_module = import_module("Vjii_Robot.utils.filters." + module_name)
